...
class SceneApp extends Scene {
  constructor() {
    ...
    const r = 0.3;
    this.cameraLight.ortho(-r, r, r, -r, 0.25, 1.8);
  ...
  _initTextures() {
    ...
    const { numParticles: num, numSets, numSegs } = Config;
    const oSettings = {
      type: GL.FLOAT,
  ...
  updateParticles() {
    ...
    const fbo = this._posArray.shift();
    fbo.bind();
    GL.clear(0, 0, 0, 0);
    this._dCopy.draw(this._fbo.read.getTexture(0));
    fbo.unbind();
