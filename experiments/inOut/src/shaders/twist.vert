...
vec3 getPos(inout vec3 normal) {
	...
	normal = rotate(vec3(0.0, 0.0, -1.0), Y_AXIS, a + aVertexPosition.z * PI * 0.5 + uTime);
	normal = rotate(normal, Z_AXIS, a);
